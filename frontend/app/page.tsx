  ...
  return (
    <main className="font-sans">
      ...
      <section className="hero h-[80vh] flex flex-col items-center justify-center text-center bg-gradient-to-r from-blue-500 to-purple-600 text-white">
        <h1 className="text-5xl font-bold mb-4">Unite Innovators and Creators</h1>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="feature-item">
              ...
              <p>Receive notifications about project updates and new opportunities.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="step-item">
              <div className="step-number text-4xl font-bold text-blue-600 mb-4">1</div>
              <h3 className="text-xl font-semibold mb-2">Sign Up</h3>
              <p>Create an account to join the community.</p>
            </div>
            <div className="step-item">
              <div className="step-number text-4xl font-bold text-blue-600 mb-4">2</div>
              <h3 className="text-xl font-semibold mb-2">Share or Explore Ideas</h3>
              <p>Post your own ideas or find projects that interest you.</p>
            </div>
            <div className="step-item">
              <div className="step-number text-4xl font-bold text-blue-600 mb-4">3</div>
      ...
      <section className="cta py-12 bg-blue-600 text-white text-center">
        <div className="container mx-auto">
          ...
          <p className="mb-6">Join CollabIdeas today and turn your ideas into reality.</p>
