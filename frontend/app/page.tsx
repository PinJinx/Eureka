    ...
    <main className="font-sans">
      ...
      <section className="hero h-[80vh] flex flex-col items-center justify-center text-center bg-gradient-to-r from-blue-500 to-purple-600 text-white">
        ...
        <button
          ...
          className="px-6 py-3 bg-white text-blue-600 font-semibold rounded-full shadow-md hover:bg-gray-100"
        >
          Get Started
        </button>
      </section>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="feature-item">
              ...
              <p>
                Post and categorize your innovative concepts to attract
                collaborators.
              </p>
            </div>
            <div className="feature-item">
